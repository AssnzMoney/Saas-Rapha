    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/20 p-4 md:p-6 lg:p-8 flex flex-col-reverse lg:flex-row gap-20 place-items-center">
      ...
      {showMockups && (
        <div className="relative max-w-md mx-auto mt-8">
          ...
          {/* Mobile App Mockup */}
          <div className="absolute -bottom-4 -right-24 md:-bottom-12 md:-right-12 w-56 h-[28rem] md:w-44 md:h-80 bg-slate-900 rounded-[2.5rem] p-2 shadow-2xl transform -rotate-12 hover:-rotate-6 transition-transform duration-300 z-10">
            <div className="w-full h-full bg-background rounded-[2rem] overflow-hidden border flex flex-col">
              {/* Phone Header */}
